...
public class PostController {
    ...
    @RequestMapping(value = "/like/{postId}",method = RequestMethod.POST)
            public void likePost(HttpSession session, HttpServletResponse resp ,@PathVariable("postId") long postId) throws UserException{
                try {
    ...
    public void unlikePost(HttpSession session,HttpServletResponse resp ,@PathVariable("postId") long postId) throws UserException, SQLException, PostException {
        System.out.println("=================================="+postId);
        try {
            Post post=postDao.getPostById(postId);
            long userId=((User)session.getAttribute("user")).getUserId();
    ...
    public void dislikePost(HttpSession session,HttpServletResponse resp ,@PathVariable("postId") long postId) throws UserException{
        try {
            System.out.println("=================================="+postId);
            Post post=postDao.getPostById(postId);
            long userId=((User)session.getAttribute("user")).getUserId();
    ...
    public void undislikePost(HttpSession session,HttpServletResponse resp ,@PathVariable("postId") long postId) throws UserException{
        System.out.println("=================================="+postId);
        try {
            Post post=postDao.getPostById(postId);
            long userId=((User)session.getAttribute("user")).getUserId();
